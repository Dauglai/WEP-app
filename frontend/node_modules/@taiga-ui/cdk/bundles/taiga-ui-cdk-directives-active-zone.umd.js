(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var TuiActiveZoneDirective = /** @class */ (function () {
        function TuiActiveZoneDirective(active$, ngZone, el, directParentActiveZone) {
            var _this = this;
            this.active$ = active$;
            this.ngZone = ngZone;
            this.el = el;
            ...
            this.tuiActiveZoneChange = this.active$.pipe(operators.map(function (element) { return !!element && _this.contains(element); }), operators.startWith(false), operators.distinctUntilChanged(), operators.skip(1), observables.tuiZoneOptimized(this.ngZone));
