(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk/decorators')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/directives/media', ['exports', '@angular/core', '@taiga-ui/cdk/decorators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].cdk = global["taiga-ui"].cdk || {}, global["taiga-ui"].cdk.directives = global["taiga-ui"].cdk.directives || {}, global["taiga-ui"].cdk.directives.media = {}), global.ng.core, global["taiga-ui"].cdk.decorators));
})(this, (function (exports, i0, decorators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    __decorate([
        decorators.tuiDefaultProp(function (volume) { return Number.isFinite(volume) && volume >= 0 && volume <= 1; })
    ], TuiMediaDirective.prototype, "volume", void 0);
    __decorate([
        decorators.tuiRequiredSetter(nonNegativeFiniteAssertion)
