(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taiga-ui/cdk/date-time'), require('@taiga-ui/cdk/classes'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/cdk/utils/miscellaneous', ['exports', '@taiga-ui/cdk/date-time', '@taiga-ui/cdk/classes', '@angular/forms'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].cdk = global["taiga-ui"].cdk || {}, global["taiga-ui"].cdk.utils = global["taiga-ui"].cdk.utils || {}, global["taiga-ui"].cdk.utils.miscellaneous = {}), global["taiga-ui"].cdk["date-time"], global["taiga-ui"].cdk.classes, global.ng.forms));
})(this, (function (exports, dateTime, classes, forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function tuiDefaultSort(x, y) {
        var a = x instanceof dateTime.TuiDay ? Number(x.toUtcNativeDate()) : x;
        var b = y instanceof dateTime.TuiDay ? Number(y.toUtcNativeDate()) : y;
        if (a === b) {
            return 0;
        }
