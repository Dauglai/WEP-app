(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/constants'), require('@taiga-ui/core/tokens'), require('@angular/common'), require('@taiga-ui/core/pipes')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/primitive-calendar', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/constants', '@taiga-ui/core/tokens', '@angular/common', '@taiga-ui/core/pipes'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].core = global["taiga-ui"].core || {}, global["taiga-ui"].core.components = global["taiga-ui"].core.components || {}, global["taiga-ui"].core.components["primitive-calendar"] = {}), global.ng.core, global.i2, global["taiga-ui"].core.constants, global["taiga-ui"].core.tokens, global.ng.common, global["taiga-ui"].core.pipes));
})(this, (function (exports, i0, i2, constants, tokens, i1, i3) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiPrimitiveCalendarComponent = /** @class */ (function () {
        ...
        Object.defineProperty(TuiPrimitiveCalendarComponent.prototype, "isSingle", {
            get: function () {
                return (this.value !== null &&
                    (this.value instanceof i2.TuiDay || this.value.isSingleDay));
            },
            enumerable: false,
            configurable: true
        });
        ...
        TuiPrimitiveCalendarComponent.prototype.itemIsInterval = function (day) {
            var _a = this, value = _a.value, hoveredItem = _a.hoveredItem;
            if (value === null || value instanceof i2.TuiDay) {
                return false;
            }
