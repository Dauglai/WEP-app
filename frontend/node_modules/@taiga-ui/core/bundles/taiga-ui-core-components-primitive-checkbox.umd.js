(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@taiga-ui/cdk'), require('@taiga-ui/core/components/svg'), require('@taiga-ui/core/directives/wrapper'), require('@tinkoff/ng-polymorpheus')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/core/components/primitive-checkbox', ['exports', '@angular/core', '@taiga-ui/cdk', '@taiga-ui/core/components/svg', '@taiga-ui/core/directives/wrapper', '@tinkoff/ng-polymorpheus'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].core = global["taiga-ui"].core || {}, global["taiga-ui"].core.components = global["taiga-ui"].core.components || {}, global["taiga-ui"].core.components["primitive-checkbox"] = {}), global.ng.core, global.cdk, global["taiga-ui"].core.components.svg, global["taiga-ui"].core.directives.wrapper, global.i3));
     ...
     */
    var TUI_CHECKBOX_OPTIONS = new i0.InjectionToken("[TUI_CHECKBOX_OPTIONS]", {
        factory: function () { return TUI_CHECKBOX_DEFAULT_OPTIONS; },
    });
    var tuiCheckboxOptionsProvider = function (options) { return ({
