    ...
    ***************************************************************************** */
    ...
    function tuiCreateTimePeriods(minHour, maxHour, minutes) {
        ...
        for (var i = minHour; i < maxHour; i++) {
            try {
                for (var minutes_1 = (e_1 = void 0, __values(minutes)), minutes_1_1 = minutes_1.next(); !minutes_1_1.done; minutes_1_1 = minutes_1.next()) {
                    var minute = minutes_1_1.value;
                ...
                try {
                    if (minutes_1_1 && !minutes_1_1.done && (_a = minutes_1.return)) _a.call(minutes_1);
                }
