# Generated by Django 3.1.14 on 2023-05-26 14:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, choices=[('Екатеринбург', 'Екатеринбург'), ('Москва', 'Москва'), ('Санкт-Петербург', 'Санкт-Петербург')], max_length=50, null=True, verbose_name='Место учебы')),
                ...
                ('gender', models.CharField(blank=True, choices=[('M', 'мужчина'), ('F', 'женщина')], max_length=50, null=True, verbose_name='Пол')),
